 ...
 */
package com.gds.weixin.util.generator;
...
public class EntityUtil {
    ...
    private final String moduleName = "public_signal";
    ...
    private final String bean_package = "com.gds.weixin.dao.po";

    private final String mapper_package = "com.gds.weixin.dao.repository";
